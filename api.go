...
// GetAccessSubscriptionsResponse represents the response for GetAccessSubscriptions
type GetAccessSubscriptionsResponse map[string]interface{}
...
// GetAccessPromotionsResponse represents the response for GetAccessPromotions
type GetAccessPromotionsResponse struct {
	Id float64 `json:"id"`
	Message string `json:"message"`
	RawMessage string `json:"rawMessage"`
	HasRelatedPromo bool `json:"hasRelatedPromo"`
...
// AccessPromotionsFinishResponse represents the response for AccessPromotionsFinish
type AccessPromotionsFinishResponse struct {
	Success bool `json:"success"`
}
...
// GetAccessSubscriptions Get subscription
func (c *Client) GetAccessSubscriptions(ctx context.Context, subscriptionId string) (*GetAccessSubscriptionsResponse, error) {
	path := fmt.Sprintf("/v2/access/subscriptions/%v", subscriptionId)
	...
	var result GetAccessSubscriptionsResponse
	if err := json.Unmarshal(respBody, &result); err != nil {
		return nil, fmt.Errorf("unmarshal response: %w", err)
	}
	return &result, nil
...
// GetAccessPromotions Get promotion
func (c *Client) GetAccessPromotions(ctx context.Context, promotionId string) (*GetAccessPromotionsResponse, error) {
	...
	var result GetAccessPromotionsResponse
	if err := json.Unmarshal(respBody, &result); err != nil {
		return nil, fmt.Errorf("unmarshal response: %w", err)
	}
	return &result, nil
...
// AccessPromotionsFinish Finish promotion
func (c *Client) AccessPromotionsFinish(ctx context.Context, promotionId string) (*AccessPromotionsFinishResponse, error) {
	path := fmt.Sprintf("/v2/access/promotions/%v/finish", promotionId)
	...
	var result AccessPromotionsFinishResponse
	if err := json.Unmarshal(respBody, &result); err != nil {
		return nil, fmt.Errorf("unmarshal response: %w", err)
	}
	return &result, nil
